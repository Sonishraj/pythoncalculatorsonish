...
def index(varargs=None):
    ...
    cursor = con.cursor()
    select_movies_query = "SELECT * FROM pythoncalc.input_output LIMIT 5"
    ...
    if(varargs in inputargslist):
        ...
        sql_query = "INSERT INTO input_output(inputargs, output, operationtype) VALUES ('{}','{}', '{}' )".format(varargs,sum,'addition')
